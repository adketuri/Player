...
Scene_Battle_Umbra::Scene_Battle_Umbra() : Scene_Battle(),
...
void Scene_Battle_Umbra::OnSystem2Ready(FileRequestResult* result) {
...
void Scene_Battle_Umbra::DrawFloatText(int x, int y, int color, const std::string& text) {
...
void Scene_Battle_Umbra::CreateBattleTargetWindow() {
...
void Scene_Battle_Umbra::CreateBattleCommandWindow() {
	std::vector<std::string> commands;
...
void Scene_Battle_Umbra::RefreshCommandWindow() {
	CreateBattleCommandWindow();
...
void Scene_Battle_Umbra::ProcessActions() {
...
bool Scene_Battle_Umbra::ProcessBattleAction(Game_BattleAlgorithm::AlgorithmBase* action) {
...
void Scene_Battle_Umbra::ProcessInput() {
...
void Scene_Battle_Umbra::CommandSelected() {
...
void Scene_Battle_Umbra::AttackSelected() {
	Scene_Battle::AttackSelected();
}

void Scene_Battle_Umbra::SubskillSelected() {
...
void Scene_Battle_Umbra::SpecialSelected() {
	Game_System::SePlay(Game_System::GetSystemSE(Game_System::SFX_Decision));
...
void Scene_Battle_Umbra::Escape() {
...
bool Scene_Battle_Umbra::CheckWin() {
...
bool Scene_Battle_Umbra::CheckLose() {
...
bool Scene_Battle_Umbra::CheckResultConditions() {
...
void Scene_Battle_Umbra::SelectNextActor() {
...
void Scene_Battle_Umbra::ActionSelectedCallback(Game_Battler* for_battler) {
...
void Scene_Battle_Umbra::ShowNotification(const std::string& text) {
	if (text.empty()) {
		return;
	}
	help_window->SetVisible(true);
